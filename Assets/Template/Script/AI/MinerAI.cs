...
public class MinerAI : MonoBehaviour
{
    ...
    private Mindingjob _currentJob;
    ...
    void findJob()
    {
        ...
        Mindingjob[] _mininglist = FindObjectsOfType<Mindingjob>();

        Mindingjob closestJob = null;
        float closestDistance = Mathf.Infinity;
         ...
         foreach (Mindingjob job in _mininglist)
         {
